...
$$g(y) = X \beta + Z \gamma + e$$
with 

* $X \beta$ the fixed effects
* $Z \gamma$ the random effects (taking care of spatio/temporal correlations)
* $e$ IID, an independent identically distributed residual (white noise)
* $g()$ the link function, explaining how the observations
